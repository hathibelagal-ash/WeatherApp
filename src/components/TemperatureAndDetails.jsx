...
function TemperatureAndDetails({
  ...
  return (
    <div>
      ...
      <div className='flex flow-row items-center justify-between text-white my-6'>
      ...
      <div className='flex flex-row items-center justify-between text-white text-sm my-6'>
